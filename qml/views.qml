...
Page {
        ...
        */
        contents: Rectangle {
            ...
            TextField {
                ...
                onTextChanged: {
                    if (searchField.text == ""){
                        jsonwallpaper.source = "https://wall.alphacoders.com/api2.0/get.php?auth=2795f44dad7746122baaa83d01db8541&method=by_views&page="+pageWall+"&info_level=1"
                    }else{
    ...
    GridView {
        ...
        model: jsonwallpaper.model
            ...
            JSONListModel {
                id: jsonwallpaper
                source: "https://wall.alphacoders.com/api2.0/get.php?auth=2795f44dad7746122baaa83d01db8541&method=by_views&page="+pageWall+"&info_level=1"
                query: "$[*]"
            }
